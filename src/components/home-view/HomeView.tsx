...
export const HomeView: React.FC = async () => {
    ...
    return (
        <div className="flex flex-col gap-10 px-5 py-5 sm:px-10">
            {favorites.length > 0 && (
                    ...
                    <div className="flex flex-wrap gap-5">
                        {favorites.map((favorite) => {
                            return (
                                ...
                                >
                                    <div className="flex items-center gap-2 rounded border border-foreground px-5 py-2 hover:bg-hover">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <Link href={`/team/${awayTeam.slug}`}>
                                            <div className="flex items-center gap-1">
                                                ...
                                                <span className="hidden sm:block">{awayTeam.college}</span>
                                            </div>
                                        </Link>
                                        <span>@</span>
                                        <Link href={`/team/${homeTeam.slug}`}>
                                            <div className="flex items-center gap-1">
                                                ...
                                                <span className="hidden sm:block">{homeTeam.college}</span>
                                            </div>
                                        </Link>
                                    </div>
                                );
